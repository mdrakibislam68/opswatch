...
exports.ServersModule = ServersModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([server_entity_1.Server]), websocket_module_1.WebsocketModule],
        controllers: [servers_controller_1.ServersController],
        providers: [servers_service_1.ServersService],
        exports: [servers_service_1.ServersService, typeorm_1.TypeOrmModule],
    })
], ServersModule);
